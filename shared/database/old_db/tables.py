...
class _Staffwarning(_Base):
    ...
    id = mapped_column(Text, nullable=True)
...
class _Dmreminder(_Base):
    ...
    message_id = mapped_column(Text, nullable=True)
...
class _MsgcountWeek(_Base):
    ...
    id = mapped_column(Text, nullable=True)
    week = mapped_column(Text, nullable=True)
    count = mapped_column(Text, nullable=True)
...
class _Glossary(_Base):
    ...
    word = mapped_column(Text, nullable=True)
...
class _Optinban(_Base):
    ...
    id = mapped_column(Text, nullable=True)
    chan = mapped_column(Text, nullable=True)
...
class _Event(_Base):
    ...
    fire_time = mapped_column(Integer, nullable=True)
    type = mapped_column(Text, nullable=True)
    data = mapped_column(Text, nullable=True)
...
class _Star(_Base):
    ...
    msgid = mapped_column(Text, nullable=True)
